...
MODEL_DIRS = {
    ...
    'qwen': 'Qwen/Qwen2.5-Coder-1.5B-Instruct',  # Added Qwen2.5-Coder-32B-Instruct model
    'deepseek': 'deepseek-ai/deepseek-coder-1.3b-base'  # Added DeepSeek-Coder 1.3B base model
}
