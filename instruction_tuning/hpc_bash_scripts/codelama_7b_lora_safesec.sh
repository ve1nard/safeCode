...
#SBATCH -o codellama7b_lora_secsafe_23.out      # Output file
#SBATCH -e codellama7b_lora_secsafe_23.err      # Error file
...
PYTHONNOUSERSITE=1 python sec_eval_secsafe.py --output_name codellama-7b-lora-safecoder-secsafe --model_name codellama-7b-lora-safecoder --eval_type trained --model_dir /scratch/dn2206/Capstone2/SafeCoder
PYTHONNOUSERSITE=1 python sec_eval_secsafe.py --output_name codellama-7b-lora-safecoder-secsafe --model_name codellama-7b-lora-safecoder --eval_type trained-new --model_dir /scratch/dn2206/Capstone2/SafeCoder


# Print Security Evaluation Results
#python print_results.py --eval_name codellama7b-safecoder --eval_type trained-joint --detail

PYTHONNOUSERSITE=1 python print_results.py --eval_name codellama-7b-lora-safecoder-secsafe --eval_type trained-joint --detail
